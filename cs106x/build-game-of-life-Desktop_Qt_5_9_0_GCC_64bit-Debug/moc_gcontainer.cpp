...
#include "../assign-1-game-of-life/lib/StanfordCPPLib/graphics/gcontainer.h"
...
void *_Internal_QContainer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata__Internal_QContainer.stringdata0))
        return static_cast<void*>(const_cast< _Internal_QContainer*>(this));
    if (!strcmp(_clname, "_Internal_QWidget"))
        return static_cast< _Internal_QWidget*>(const_cast< _Internal_QContainer*>(this));
