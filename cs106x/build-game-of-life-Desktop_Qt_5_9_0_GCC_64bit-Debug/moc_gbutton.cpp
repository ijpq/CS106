...
#include "../assign-1-game-of-life/lib/StanfordCPPLib/graphics/gbutton.h"
...
void _Internal_QPushButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&_Internal_QPushButton::doubleClicked)) {
                *result = 0;
                return;
            }
        }
...
void *_Internal_QPushButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata__Internal_QPushButton.stringdata0))
        return static_cast<void*>(const_cast< _Internal_QPushButton*>(this));
    if (!strcmp(_clname, "_Internal_QWidget"))
        return static_cast< _Internal_QWidget*>(const_cast< _Internal_QPushButton*>(this));
