...
#include "../assign-1-game-of-life/lib/StanfordCPPLib/graphics/gslider.h"
...
void _Internal_QSlider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        _Internal_QSlider *_t = static_cast<_Internal_QSlider *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject _Internal_QSlider::staticMetaObject = {
    { &QSlider::staticMetaObject, qt_meta_stringdata__Internal_QSlider.data,
      qt_meta_data__Internal_QSlider,  qt_static_metacall, nullptr, nullptr}
};
...
void *_Internal_QSlider::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata__Internal_QSlider.stringdata0))
        return static_cast<void*>(const_cast< _Internal_QSlider*>(this));
    if (!strcmp(_clname, "_Internal_QWidget"))
        return static_cast< _Internal_QWidget*>(const_cast< _Internal_QSlider*>(this));
