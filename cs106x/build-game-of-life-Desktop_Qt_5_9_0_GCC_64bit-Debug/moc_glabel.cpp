...
#include "../assign-1-game-of-life/lib/StanfordCPPLib/graphics/glabel.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata__Internal_QLabel_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata__Internal_QLabel_t qt_meta_stringdata__Internal_QLabel = {
    {
QT_MOC_LITERAL(0, 0, 16), // "_Internal_QLabel"
QT_MOC_LITERAL(1, 17, 7), // "clicked"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 13) // "doubleClicked"
...
void _Internal_QLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        _Internal_QLabel *_t = static_cast<_Internal_QLabel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (_Internal_QLabel::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&_Internal_QLabel::clicked)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (_Internal_QLabel::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&_Internal_QLabel::doubleClicked)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject _Internal_QLabel::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata__Internal_QLabel.data,
      qt_meta_data__Internal_QLabel,  qt_static_metacall, nullptr, nullptr}
};
...
void *_Internal_QLabel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata__Internal_QLabel.stringdata0))
        return static_cast<void*>(const_cast< _Internal_QLabel*>(this));
    if (!strcmp(_clname, "_Internal_QWidget"))
        return static_cast< _Internal_QWidget*>(const_cast< _Internal_QLabel*>(this));
