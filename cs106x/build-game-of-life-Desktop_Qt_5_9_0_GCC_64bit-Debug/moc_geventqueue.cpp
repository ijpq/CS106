...
#include "../assign-1-game-of-life/lib/StanfordCPPLib/graphics/geventqueue.h"
...
void GEventQueue::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GEventQueue::eventReady)) {
                *result = 0;
                return;
            }
        }
...
void *GEventQueue::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_GEventQueue.stringdata0))
        return static_cast<void*>(const_cast< GEventQueue*>(this));
