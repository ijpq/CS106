...
#include "../assign-1-game-of-life/lib/StanfordCPPLib/graphics/gscrollbar.h"
...
void *_Internal_QScrollBar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata__Internal_QScrollBar.stringdata0))
        return static_cast<void*>(const_cast< _Internal_QScrollBar*>(this));
    if (!strcmp(_clname, "_Internal_QWidget"))
        return static_cast< _Internal_QWidget*>(const_cast< _Internal_QScrollBar*>(this));
