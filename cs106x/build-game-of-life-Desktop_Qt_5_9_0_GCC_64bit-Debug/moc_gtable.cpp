...
#include "../assign-1-game-of-life/lib/StanfordCPPLib/graphics/gtable.h"
...
const QMetaObject _Internal_QItemDelegate::staticMetaObject = {
    { &QStyledItemDelegate::staticMetaObject, qt_meta_stringdata__Internal_QItemDelegate.data,
      qt_meta_data__Internal_QItemDelegate,  qt_static_metacall, nullptr, nullptr}
};
...
void *_Internal_QItemDelegate::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata__Internal_QItemDelegate.stringdata0))
        return static_cast<void*>(const_cast< _Internal_QItemDelegate*>(this));
...
void _Internal_QTableWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        _Internal_QTableWidget *_t = static_cast<_Internal_QTableWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject _Internal_QTableWidget::staticMetaObject = {
    { &QTableWidget::staticMetaObject, qt_meta_stringdata__Internal_QTableWidget.data,
      qt_meta_data__Internal_QTableWidget,  qt_static_metacall, nullptr, nullptr}
};
...
void *_Internal_QTableWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata__Internal_QTableWidget.stringdata0))
        return static_cast<void*>(const_cast< _Internal_QTableWidget*>(this));
    if (!strcmp(_clname, "_Internal_QWidget"))
        return static_cast< _Internal_QWidget*>(const_cast< _Internal_QTableWidget*>(this));
