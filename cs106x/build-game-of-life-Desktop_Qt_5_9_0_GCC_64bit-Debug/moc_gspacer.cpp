...
#include "../assign-1-game-of-life/lib/StanfordCPPLib/graphics/gspacer.h"
...
const QMetaObject _Internal_QSpacer::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata__Internal_QSpacer.data,
      qt_meta_data__Internal_QSpacer,  qt_static_metacall, nullptr, nullptr}
};
...
void *_Internal_QSpacer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata__Internal_QSpacer.stringdata0))
        return static_cast<void*>(const_cast< _Internal_QSpacer*>(this));
    if (!strcmp(_clname, "_Internal_QWidget"))
        return static_cast< _Internal_QWidget*>(const_cast< _Internal_QSpacer*>(this));
