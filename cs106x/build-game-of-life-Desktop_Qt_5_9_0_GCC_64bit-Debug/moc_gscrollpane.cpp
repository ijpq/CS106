...
#include "../assign-1-game-of-life/lib/StanfordCPPLib/graphics/gscrollpane.h"
...
void *_Internal_QScrollArea::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata__Internal_QScrollArea.stringdata0))
        return static_cast<void*>(const_cast< _Internal_QScrollArea*>(this));
    if (!strcmp(_clname, "_Internal_QWidget"))
        return static_cast< _Internal_QWidget*>(const_cast< _Internal_QScrollArea*>(this));
