...
#include "../assign-1-game-of-life/lib/StanfordCPPLib/graphics/gtextarea.h"
...
void *_Internal_QTextEdit::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata__Internal_QTextEdit.stringdata0))
        return static_cast<void*>(const_cast< _Internal_QTextEdit*>(this));
    if (!strcmp(_clname, "_Internal_QWidget"))
        return static_cast< _Internal_QWidget*>(const_cast< _Internal_QTextEdit*>(this));
