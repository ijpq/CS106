...
#include "../assign-1-game-of-life/lib/StanfordCPPLib/graphics/gtextfield.h"
...
void _Internal_QLineEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        _Internal_QLineEdit *_t = static_cast<_Internal_QLineEdit *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject _Internal_QLineEdit::staticMetaObject = {
    { &QLineEdit::staticMetaObject, qt_meta_stringdata__Internal_QLineEdit.data,
      qt_meta_data__Internal_QLineEdit,  qt_static_metacall, nullptr, nullptr}
};
...
void *_Internal_QLineEdit::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata__Internal_QLineEdit.stringdata0))
        return static_cast<void*>(const_cast< _Internal_QLineEdit*>(this));
    if (!strcmp(_clname, "_Internal_QWidget"))
        return static_cast< _Internal_QWidget*>(const_cast< _Internal_QLineEdit*>(this));
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        _Internal_QSpinBox *_t = static_cast<_Internal_QSpinBox *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->handleTextChange((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
...
const QMetaObject _Internal_QSpinBox::staticMetaObject = {
    { &QSpinBox::staticMetaObject, qt_meta_stringdata__Internal_QSpinBox.data,
      qt_meta_data__Internal_QSpinBox,  qt_static_metacall, nullptr, nullptr}
};
...
void *_Internal_QSpinBox::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata__Internal_QSpinBox.stringdata0))
        return static_cast<void*>(const_cast< _Internal_QSpinBox*>(this));
    if (!strcmp(_clname, "_Internal_QWidget"))
        return static_cast< _Internal_QWidget*>(const_cast< _Internal_QSpinBox*>(this));
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        _Internal_QDoubleSpinBox *_t = static_cast<_Internal_QDoubleSpinBox *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->handleTextChange((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
...
const QMetaObject _Internal_QDoubleSpinBox::staticMetaObject = {
    { &QDoubleSpinBox::staticMetaObject, qt_meta_stringdata__Internal_QDoubleSpinBox.data,
      qt_meta_data__Internal_QDoubleSpinBox,  qt_static_metacall, nullptr, nullptr}
};
...
void *_Internal_QDoubleSpinBox::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata__Internal_QDoubleSpinBox.stringdata0))
        return static_cast<void*>(const_cast< _Internal_QDoubleSpinBox*>(this));
    if (!strcmp(_clname, "_Internal_QWidget"))
        return static_cast< _Internal_QWidget*>(const_cast< _Internal_QDoubleSpinBox*>(this));
