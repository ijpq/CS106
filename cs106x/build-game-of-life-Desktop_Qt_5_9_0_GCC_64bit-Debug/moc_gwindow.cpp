...
#include "../assign-1-game-of-life/lib/StanfordCPPLib/graphics/gwindow.h"
...
void _Internal_QMainWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        _Internal_QMainWindow *_t = static_cast<_Internal_QMainWindow *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject _Internal_QMainWindow::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata__Internal_QMainWindow.data,
      qt_meta_data__Internal_QMainWindow,  qt_static_metacall, nullptr, nullptr}
};
...
void *_Internal_QMainWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata__Internal_QMainWindow.stringdata0))
        return static_cast<void*>(const_cast< _Internal_QMainWindow*>(this));
