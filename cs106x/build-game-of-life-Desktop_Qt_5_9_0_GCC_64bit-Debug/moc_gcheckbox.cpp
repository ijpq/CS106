...
void _Internal_QCheckBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        _Internal_QCheckBox *_t = static_cast<_Internal_QCheckBox *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (_Internal_QCheckBox::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&_Internal_QCheckBox::doubleClicked)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject _Internal_QCheckBox::staticMetaObject = {
    { &QCheckBox::staticMetaObject, qt_meta_stringdata__Internal_QCheckBox.data,
      qt_meta_data__Internal_QCheckBox,  qt_static_metacall, nullptr, nullptr}
};
...
void *_Internal_QCheckBox::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata__Internal_QCheckBox.stringdata0))
        return static_cast<void*>(const_cast< _Internal_QCheckBox*>(this));
    if (!strcmp(_clname, "_Internal_QWidget"))
        return static_cast< _Internal_QWidget*>(const_cast< _Internal_QCheckBox*>(this));
