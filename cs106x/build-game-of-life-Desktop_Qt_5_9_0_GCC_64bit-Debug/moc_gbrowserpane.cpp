...
#include "../assign-1-game-of-life/lib/StanfordCPPLib/graphics/gbrowserpane.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata__Internal_QTextBrowser_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata__Internal_QTextBrowser_t qt_meta_stringdata__Internal_QTextBrowser = {
    {
QT_MOC_LITERAL(0, 0, 22) // "_Internal_QTextBrowser"
...
const QMetaObject _Internal_QTextBrowser::staticMetaObject = {
    { &QTextBrowser::staticMetaObject, qt_meta_stringdata__Internal_QTextBrowser.data,
      qt_meta_data__Internal_QTextBrowser,  qt_static_metacall, nullptr, nullptr}
};
...
void *_Internal_QTextBrowser::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata__Internal_QTextBrowser.stringdata0))
        return static_cast<void*>(const_cast< _Internal_QTextBrowser*>(this));
    if (!strcmp(_clname, "_Internal_QWidget"))
        return static_cast< _Internal_QWidget*>(const_cast< _Internal_QTextBrowser*>(this));
