...
public:
     ...
     */
    Q_DECL_DEPRECATED virtual void addActionListener() ;   // does nothing
     ...
     * @private
     */
    Q_DECL_DEPRECATED virtual char getMnemonic() const ;
     ...
     * @private
     */
    Q_DECL_DEPRECATED virtual void setMnemonic(char mnemonic) ;
